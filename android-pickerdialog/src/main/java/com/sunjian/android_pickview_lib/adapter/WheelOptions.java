...
public class WheelOptions<A, B, C> {
    private View view;
    private WheelView wv_option1;
    private WheelView wv_option2;
    private WheelView wv_option3;

    private ArrayList<A> mOptions1Items;
    private ArrayList<ArrayList<B>> mOptions2Items;
    private ArrayList<ArrayList<ArrayList<C>>> mOptions3Items;
    ...
    public WheelOptions(View view, int textSize) {
        this.view = view;
    ...
    public void setPicker(ArrayList<A> options1Items,
        ...
        int options1Id = resources.getIdentifier("options1", "id", packageName);
        // 选项1
        wv_option1 = (WheelView) view.findViewById(options1Id);
        wv_option1.setAdapter(new ArrayWheelAdapter(mOptions1Items, len));// 设置显示数据
        wv_option1.setCurrentItem(0);// 初始化时显示的数据

        int options2Id = resources.getIdentifier("options2", "id", packageName);
        // 选项2
        wv_option2 = (WheelView) view.findViewById(options2Id);
        ...
        int options3Id = resources.getIdentifier("options3", "id", packageName);
        // 选项3
        wv_option3 = (WheelView) view.findViewById(options3Id);
